...
class drawFeatureButton extends Control {
  ...
  constructor(opt_options) {
    ...
    async function SaveDatatodb(attrs) {
      ...
      let formattedGeojson = formatToGeojson.writeFeaturesObject(
    ...
    button.addEventListener(
      'click',
      this.launchModal.bind(this, options.map, drawSource),
      false
    );

    // begin drawing line
    document
      .getElementById('linestring-btn')
  ...
  initiateDraw(map, drawSource, geomType) {
    ...
    draw.on('drawstart', function (evt) {
      // executed at the beginning of a draw interaction
      console.log('hello');
    });
